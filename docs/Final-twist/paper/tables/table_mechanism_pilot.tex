...
attack & $n$ & $\rho_S(H,A)$ & $\rho_S(H,A \mid d_\Psi)$ & low & mid & high \\
\midrule
...
perturbation size via $d_\Psi$, the partial rank correlation is negative for all three attacks
...
count. Pilot caveats: single architecture; $d_\Psi$ is a proxy for $\|\delta\|$ (the exact
