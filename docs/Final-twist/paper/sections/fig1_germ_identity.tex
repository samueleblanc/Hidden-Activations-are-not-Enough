...
\begin{tikzpicture}[x=1cm,y=1cm,font=\small,>={Stealth[length=2mm]}]
  ...
  % network
  \node[draw,rounded corners,minimum width=2.2cm,minimum height=1.2cm,fill=blue!6] (net) at (3.1,0) {$f_\theta$};
  ...
  \begin{scope}[shift={(6.4,-1.05)}]
    ...
    \node[font=\scriptsize,align=center] at (1.75,2.45) {$d$ columns: $\partial f_c/\partial x_i \cdot x_i$\\[-1pt](gradient$\times$input, per class)};
