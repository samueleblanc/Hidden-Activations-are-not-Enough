\section{Study 3: alignment-free cross-architecture comparison (A3)}
\label{sec:study4}
\label{sec:A3}
...
separate controls reduce used by Study~1). Without them the cross-architecture
...
coherence $A=(d_\Psi/d_M)^2$ available per pair from the same two stored
